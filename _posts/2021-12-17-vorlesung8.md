...
Als Beispiele haben wir uns den OPAC der technischen Universität Hamburg und Universitätsbibliothek Leipzig angesehen. Für die Schweiz war das Beispiel [swisscollections](https://swisscollections.ch/). Es ist eine Ergänzung zu [swisscovery](https://swisscovery.slsp.ch/discovery/search?vid=41SLSP_NETWORK:VU1_UNION).
